                                 ...
                                 <div>
                                     ...
                                     <div class="mt-2 mb-2 d-flex flex-column flex-md-row">
                                         ...
                                         <a href="{{ getAdminPanelUrl() }}/supports"
                                             class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i
                                                 class="far fa-envelope"></i>{{ ucfirst(trans('admin/main.tickets')) }}</a>
                             ...
                             @can('admin_clear_cache')
                                 <div class="w-xs-to-lg-100">
                                     ...
                                     @include('admin.includes.delete_button', [
                                         ...
                                         'btnClass' =>
                                             'btn btn-outline-white btn-lg btn-icon icon-left mt-2 w-100',
                         ...
                         <div class="card card-statistic-2">
                             <div class="card-stats">
                                 ...
                                 <div class="card-stats-items">
                                     ...
                                     <div class="card-stats-item">
                                         <div class="card-stats-item-count">{{ $dailySalesTypeStatistics['syllabusSales'] }}
                                         </div>
                                         <div class="card-stats-item-label">{{ trans('admin/main.syllabusSales') }}</div>
                                     </div>
                         ...
                         <div class="card card-statistic-2">
                             <div class="card-stats">
                                 ...
                                 <div class="card-stats-items">
                                     ...
                                     <div class="card-stats-item">
                                         <div class="card-stats-item-count">
                                             {{ handlePrice($getIncomeStatistics['yearSales']) }}</div>
                         ...
                         <table style='width:100%'>
                             <thead class="w-full">
                                 <tr className="w-full  text-gray-600 uppercase text-sm leading-normal">
                                     ...
                                     <th className="py-3 px-6">Product Cost</th>
                         ...
                         <div class="card card-hero">
                             ...
                             <div class="card-body p-0">
                                 <div class="tickets-list">
                                     ...
                                     <a href="{{ getAdminPanelUrl() }}/webinars?type=course"
         ...
         @can('admin_general_dashboard_users_statistics_chart')
             <div hidden class="row">
                 <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                     <div class="card">
                         <div class="card-header">
                             <h4 hidden>{{ trans('admin/main.new_registration_statistics') }}</h4>
                             <div class="card-header-action">
                                 <div class="btn-group">
                                     {{-- <a hidden href="#" class="btn">Views
                                    </a> --}}
                                 </div>
                             </div>
                         </div>
