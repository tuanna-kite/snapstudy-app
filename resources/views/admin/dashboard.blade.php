                            ...
                            @can('admin_general_dashboard_quick_access_links')
                                <div>
                                    ...
                                    <div class="mt-2 mb-2 d-flex flex-column flex-md-row">
                                        ...
                                        <a href="{{ getAdminPanelUrl() }}/supports" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="far fa-envelope"></i>{{ucfirst(trans('admin/main.tickets'))}}</a>
                        ...
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                ...
                                <div class="card-stats-items">
                                    ...
                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count">{{ $dailySalesTypeStatistics['syllabusSales'] }}</div>
