    ...
    <section class="section">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4>{{trans('admin/main.Revenue of categories')}}</h4>
                    </div>
                    <div>
                        <canvas id="revenueChart" width="400" height="242"></canvas>
                    </div>
                </div>
            </div>
        </div>
...
@push('scripts_bottom')
    ...
    <script>
        ...
        revenueByCategory.forEach(function(item) {
            labels.push(item.slug);
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: labels, // Tên của các danh mục
                datasets: [{
                    label: 'Total Revenue',
                    data: data, // Tổng doanh thu của các danh mục
