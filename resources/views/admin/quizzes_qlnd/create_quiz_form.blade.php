...
@endphp
<form action="{{ getAdminPanelUrl() }}/quizzes/content/{{ !empty($quiz) ? $quiz->id . '/update' : 'store' }}" method="POST" id="quizzForm"
        ...
        <div class="row">
            <div class="col-12 col-md-4">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" name="seo_description" rows="5"
    ...
    <div class="mt-20 mb-20">
        ...
        @if (!empty($webinar) ? $webinar->status == \App\Models\Webinar::$reviewed : false)
            <button type="button" id="savePending"
                    class="btn btn-sm btn-warning">Phê duyệt</button>
            <button type="button" id="saveReject"
                    class="btn btn-sm btn-warning">Từ chối</button>
        @endif
    </div>
</form>
