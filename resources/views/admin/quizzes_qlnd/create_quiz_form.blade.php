...
@endphp
<div data-action="{{ getAdminPanelUrl() }}/quizzes/content/{{ !empty($quiz) ? $quiz->id . '/update' : 'store' }}"
        ...
        <div class="row">
            <div class="col-12 col-md-4">
                ...
                <div class="form-group mt-15 ">
                    ...
                    <select name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][genre]"
                ...
                <div class="form-group mt-15">
                    <label class="input-label">{{ trans('public.implementation_cost') }}
                        ( VND )</label>
                    <input type="text" name="ajax[{{ !empty($quiz) ? $quiz->id : 'new' }}][implementation_cost]"
