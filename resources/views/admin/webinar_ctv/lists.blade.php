                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td width="18%" class="text-left">
                                                <a class="text-primary mt-0 mb-1 font-weight-bold"
                                                    href="{{ route('webinar.preview', ['id' => $webinar->id]) }}">{{ $webinar->title }}</a>
                                            ...
                                            <td>
                                                <span class="mt-0 mb-1 uppercase">
                                                    {{ $webinar->type }}
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td width="200" class="">
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu text-left webinars-lists-dropdown">
                                                        ...
                                                        @can('admin_webinars_ctv')
                                                            <a href="{{ $webinar->type == \App\Models\Webinar::$webinar ? route('webinar.assign.edit', ['id' => $webinar->id]) : route('assign.quizzes.edit', ['id' => $webinar->one_quizzes->id]) }}"
                                                                target="_blank"
