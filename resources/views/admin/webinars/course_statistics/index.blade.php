    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="{{ getAdminPanelUrl() }}/webinars">{{ trans('admin/main.classes') }}</a>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 col-md-3 d-flex align-items-center justify-content-center">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <strong
                                class="font-30 font-weight-bold text-dark mt-1">{{ (!empty($salesAmount) and $salesAmount > 0) ? handlePrice($salesAmount) : 0 }}</strong>
        ...
        <section>
            <div class="row">
                <div class="col-6 col-md-4 mt-3">
                    <div class="course-statistic-cards-shadow py-3 px-2 py-md-3 px-md-3 rounded-sm bg-white">
                        <div class="d-flex align-items-center flex-column">
                            ...
                            @include('admin.webinars.includes.rate', [
                                'rate' => $courseRate,
                                'className' => 'mt-2',
                                'dontShowRate' => true,
                                'showRateStars' => true,
                ...
                <div class="col-6 col-md-4 mt-3">
                    <div class="course-statistic-cards-shadow py-3 px-2 py-md-3 px-md-3 rounded-sm bg-white">
                        <div class="d-flex align-items-center flex-column">
                            <img src="/assets/default/img/activity/homework.svg" width="64" height="64"
                                alt="">

                            <span
                                class="font-30 text-dark mt-3 font-weight-bold">{{ $webinar->assignments->count() }}</span>
                                ...
                                <table class="table custom-table text-center ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-gray">{{ trans('update.unsent_assignments') }}
                                            </th>
                                            <th class="text-center text-gray">{{ trans('update.pending_assignments') }}
                                            </th>
                                            ...
                                            <tr>
                                                <td class="text-left">
                                                    <div class="user-inline-avatar d-flex align-items-center">
                                                        ...
                                                        <div class=" ml-2">
                                                            <span
                                                                class="d-block text-dark font-weight-500">{{ $user->full_name }}</span>
                                                            <span
                                                                class="mt-2 d-block font-12 text-gray">{{ $user->email }}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                {{-- <td class="align-middle">
                                                    <span
                                                        class="text-dark font-weight-500">{{ $user->course_progress ?? 0 }}%</span>
                                                </td> --}}
                                                <td class="align-middle">
                                                    <span
                                                        class="text-dark font-weight-500">{{ $user->passed_quizzes ?? 0 }}</span>
                                                </td>
                                                <td class="align-middle">
                                                    <span
                                                        class="text-dark font-weight-500">{{ $user->unsent_assignments ?? 0 }}</span>
                                                </td>
                                                <td class="align-middle">
                                                    <span
                                                        class="text-dark font-weight-500">{{ $user->pending_assignments ?? 0 }}</span>
                                                </td>
                                                <td class="align-middle">
                                                    @if (empty($user->id))
                                                        <span
                                                            class="text-warning">{{ trans('update.unregistered') }}</span>
                                                    @else
                                                        <span
                                                            class="text-dark font-weight-500">{{ dateTimeFormat($user->created_at, 'j M Y | H:i') }}</span>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
