<div class="" style="min-height: 200vh">
    ...
    <div class="flex flex-col gap-8 p-4 md:p-12">
        <div class="w-full md:w-3/4 flex flex-col">
            <div class="w-full md:w-3/4 mx-auto">
                <x-search.search-doc />
            </div>
            <h1 class="font-bold text-3xl md:text-4xl lg:text-5xl text-primary.main text-center mt-10 md:mt-20 lg:mt-24 mb-8 md:mb-12">
                Search for outlines that fit your major
            </h1>
            <x-majors.list />
            <h1 class="font-bold text-3xl md:text-4xl lg:text-5xl text-primary.main text-center mt-20 md:mt-24 lg:mt-32 mb-8 md:mb-12">
        ...
        <div class="space-y-2">
            <div class="flex items-center justify-between">
                ...
                <a href="#" class="flex items-center">
                    <span class="font-medium text-sm md:text-base text-text.light.secondary">View all
                    </span>
    ...
    <div class="mt-10 md:mt-24 flex flex-col md:flex-row items-center justify-between container mx-auto">
        <div class="space-y-6 w-full md:w-1/2">
            <h1 class="font-bold text-3xl md:text-4xl lg:text-5xl text-primary.main">
                Students' Results <br /> with SNAPS
            </h1>
            <p class="font-normal text-base md:text-lg">
                <span class="font-bold text-3xl md:text-4xl lg:text-5xl text-secondary.main">96%</span> of our customers said that they gained
