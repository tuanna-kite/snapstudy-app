...
@section('content')
    ...
    <section class="container mt-45">
        ...
        <form action="{{ route('payment.request') }}" method="post" class=" mt-25">
            {{ csrf_field() }}
            ...
            <div class="mt-45 detail-payment-mobile">
                <div class="my-2 ">
                    <div class="font-24 font-weight-700 text-gray total_amount">{{ trans('financial.total_amount') }} :
                    </div>
                    <div class="font-24 font-weight-700 text-gray total_amount">{{ handlePrice($total) }}</div>
                </div>
