<div class="special-offer-card d-flex flex-column flex-md-row align-items-center justify-content-between rounded-lg shadow-xs bg-white p-15 p-md-30 position-relative">
    ...
    <div class="offer-percent-box d-flex flex-column align-items-center justify-content-center">
        <span class="percent text-white off-sale-mj1">Giảm</span>
        <span class="percent text-white">{{ $activeSpecialOffer->percent }}%</span>
        <span class="off text-white off-sale-mj2">{{ trans('public.off') }}</span>
    </div>
</div>
