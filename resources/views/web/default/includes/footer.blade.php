...
<style>
   @media screen and (max-width:768px){
    ...
    .phone-email-last-footer-mj{
        display: flex;
        justify-content:space-between;
        width: 100%;
    }
   }
   .footer-mj .footer-mj2{
...
<footer class="footer bg-secondary position-relative user-select-none">
    ...
    <div class="container">
        <div class="row px-3 footer-mj">

            @foreach($columns as $column)
                <div class="col-12 col-md-3 footer-mj2">
                    @if(!empty($footerColumns[$column]))
                        @if(!empty($footerColumns[$column]['title']))
                            <span class="header d-block text-white font-weight-bold mt-3">{{ $footerColumns[$column]['title'] }}</span>
                        @endif
    ...
    @if(getOthersPersonalizationSettings('platform_phone_and_email_position') == 'footer')
        <div class="footer-copyright-card">
            <div class="container d-flex align-items-center justify-content-between py-15">
                <div class="font-14 text-white text-last-footer-mj">{{ trans('update.platform_copyright_hint') }}</div>

                <div class="d-flex align-items-center justify-content-lg-center phone-email-last-footer-mj justify-content-md-between">
