...
<nav id="navbar" class="navbar navbar-expand-lg navbar-light menu-update-mj">
    <div class="{{ (!empty($isPanel) and $isPanel) ? 'container-fluid' : 'container'}}">
        <div class="d-flex align-items-center justify-content-between w-100">
           ...
           <a class="navbar-brand navbar-order d-flex align-items-center justify-content-center mr-0 {{ (empty($navBtnUrl) and empty($navBtnText)) ? '' : '' }}" href="/">
                 @if(!empty($generalSettings['logo']))
                <img src="{{ $generalSettings['logo'] }}" class="img-cover w-75" alt="site logo">
                @endif
            </a>
            ...
            {{-- <div class="mx-lg-30 d-none d-lg-flex flex-grow-1 navbar-toggle-content " id="navbarContent">
                ...
                <ul class="navbar-nav mr-auto d-flex align-items-center">
                    ...
                    @php
                    unset($navbarPages[2]); // Xóa phần tử thứ 2
                    unset($navbarPages[3]); // Xóa phần tử thứ 3
                    @endphp
