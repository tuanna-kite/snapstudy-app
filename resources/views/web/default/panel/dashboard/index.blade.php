...
@section('content')
    ...
    <section class="dashboard">
        <div class="row">
            ...
            <div class="mt-20 pt-10 pb-10  border-top border-gray300 d-flex align-items-center @if($can_drawable) justify-content-between @else justify-content-center @endif rounded" style="background-color: #c92d39;">
                {{-- @if($can_drawable)
