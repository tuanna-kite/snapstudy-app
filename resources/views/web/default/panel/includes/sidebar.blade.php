...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <div class="user-info user-info-mj d-flex align-items-center flex-row flex-lg-column justify-content-lg-center">
        ...
        <div class="d-flex flex-column align-items-center justify-content-center user-mjjj">
            <a href="/panel" class="user-name mt-15">
                <h3 class="font-16 font-weight-bold text-left">{{ $authUser->full_name }}</h3>
            </a>
   ...
   <!-- <div class="d-flex sidebar-user-stats pb-10 ml-20 pb-lg-20 mt-15 mt-lg-30">
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu pt-10 @if(!empty($authUser->userGroup)) has-user-group @endif @if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])) without-bottom-image @endif" @if((!empty($isRtl) and $isRtl)) data-simplebar-direction="rtl" @endif>
        ...
        {{--  --}}
        <li class="sidenav-item {{ (request()->is('panel/financial/account')) ? 'sidenav-item-active' : '' }}">
            <a href="/panel/financial/account" class="d-flex align-items-center">
                <span class="sidenav-item-icon mr-10">
                    @include('web.default.panel.includes.sidebar_icons.financial')
                </span>
                <span class="font-14 text-dark-blue font-weight-500">{{ trans('financial.charge_account') }}</span>
            </a>
        </li>
{{--  --}}
...
{{--
        ...
        <li class="sidenav-item {{ (request()->is('panel/financial') or request()->is('panel/financial/*')) && !request()->is('panel/financial/account') ? 'sidenav-item-active' : '' }}">
            ...
            <div class="collapse {{ (request()->is('panel/financial') or request()->is('panel/financial/*')) && !request()->is('panel/financial/account') ? 'show' : '' }}" id="financialCollapse">
                <ul class="sidenav-item-collapse">
