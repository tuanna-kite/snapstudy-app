            ...
            <div class="row">
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5" style="white-space: nowrap;">{{ $availablePoints }}</strong>
                        <span class="font-16 text-gray font-weight-500" style="white-space: nowrap;">{{ trans('update.available_points') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5" style="white-space: nowrap;">{{ $totalPoints }}</strong>
                        <span class="font-16 text-gray font-weight-500" style="white-space: nowrap;">{{ trans('update.total_points') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex align-items-center justify-content-center">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <strong class="font-30 text-dark-blue font-weight-bold mt-5" style="white-space: nowrap;">{{ $spentPoints }}</strong>
                        <span class="font-16 text-gray font-weight-500" style="white-space: nowrap;">{{ trans('update.spent_points') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-lg-6 mt-20 mt-lg-0">
            <div class="d-flex align-items-center justify-content-between rounded-sm bg-white p-15 shadow-lg">
                ...
                <div class="flex-grow-1 ml-15 text-right">
                    <a href="{{ (!empty($rewardsSettings) and !empty($rewardsSettings['want_more_points_link'])) ? $rewardsSettings['want_more_points_link'] : '' }}" class="btn btn-sm btn-border-white d-none">{{ trans('update.view_more') }}</a>
                </div>
            </div>
