    ...
    <form method="post" action="/panel/support/store">
        ...
        <section>
            ...
            <div class="mt-25 rounded-sm shadow py-20 px-10 px-lg-25 bg-white">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 d-flex align-items-center button-new-support-snap">
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm ml-40 mt-10 btn-new-mj">{{ trans('site.send_message') }}</button>
                    </div>
                </div>
            </div>
        </section>
