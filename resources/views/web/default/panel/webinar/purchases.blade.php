        ...
        if(!empty($sale->webinar) and $sale->webinar->start_date <= time() and !empty($lastSession) and $lastSession->date > time()) {
            ...
            <div class="my-15">
                <div class="webinar-card webinar-list d-flex flex-column" style="">
                    {{-- <div class="image-box">
                        <a href="{{ $item->getUrl() }}">
                             <img src="{{ $item->getImage() }}" class="img-cover" alt="{{ $item->title }}">
                            <img src="{{ $item->getImage() }}" class="img-cover" alt="{{ $item->title }}" style="max-height:250px;border-radius: 15px;object-fit:cover">
                        </a>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="btn-webinar-card-body">
                               ...
                               text-align: left !important;
                                white-space: nowrap;
                                overflow: hidden" href="{{ $item->getUrl() }}">
