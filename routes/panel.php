...
Route::group(['namespace' => 'Panel', 'prefix' => 'panel', 'middleware' => ['check_mobile_app', 'impersonate', 'panel', 'share', 'check_maintenance']], function () {
    ...
    Route::group(['prefix' => 'financial'], function () {
        ...
        // Route::get('/account/payout', 'AccountingController@accountPayout');
         Route::get('/account/success', 'AccountingController@paypalSuccess')->name('account.paypal.success');
        ...
        Route::get('/9pay/result', 'AccountingController@ninePayResule')->name('9pay.result');
    ...
    Route::group(['prefix' => 'notifications'], function () {
        ...
        Route::get('/mark-all-as-read', 'NotificationsController@markAllAsRead')->name('notification.read');
    });
