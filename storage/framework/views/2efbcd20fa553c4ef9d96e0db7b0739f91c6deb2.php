...
<?php $__env->startSection('content'); ?>
    ...
    <section class="dashboard">
        <div class="row">
            ...
            <div class="mt-20 pt-10 pb-10  border-top border-gray300 d-flex align-items-center <?php if($can_drawable): ?> justify-content-between <?php else: ?> justify-content-center <?php endif; ?> rounded" style="background-color: #c92d39;">
                
                    <a href="/panel/financial/account" class="font-16 font-weight-bold text-white"><?php echo e(trans('financial.charge_account')); ?></a>
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/tuanna.kite/workspace/laravel-app/snapstudy-app/resources/views/web/default/panel/dashboard/index.blade.php ENDPATH**/ ?>