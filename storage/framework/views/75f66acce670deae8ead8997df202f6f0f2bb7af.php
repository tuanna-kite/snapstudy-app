                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_quick_access_links')): ?>
                                <div>
                                    ...
                                    <div class="mt-2 mb-2 d-flex flex-column flex-md-row">
                                        ...
                                        <a href="<?php echo e(getAdminPanelUrl()); ?>/supports" class="mt-2 mt-md-0 btn btn-outline-white btn-lg btn-icon icon-left ml-0 ml-md-2"><i class="far fa-envelope"></i><?php echo e(ucfirst(trans('admin/main.tickets'))); ?></a>
                        ...
                        <div class="card card-statistic-2">
                            <div class="card-stats">
                                ...
                                <div class="card-stats-items">
                                    ...
                                    <div class="card-stats-item">
                                        <div class="card-stats-item-count"><?php echo e($dailySalesTypeStatistics['syllabusSales']); ?></div>
                                        <div class="card-stats-item-label"><?php echo e(trans('admin/main.syllabusSales')); ?></div>
                                    </div>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_general_dashboard_users_statistics_chart')): ?>
            <div hidden class="row">
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 hidden><?php echo e(trans('admin/main.new_registration_statistics')); ?></h4>
                            <div class="card-header-action">
                                <div class="btn-group">
