    ...
    <div class="py-8 md:py-0 relative flex-1 flex justify-between flex-col md:flex-row items-center rounded-2xl px-10 bg-primary.light"
        ...
        <div class="w-full mt-5 hidden md:mt-0 md:w-fit sm:flex sm:justify-center md:justify-end">
            <img class="w-9/12 md:w-full" style="max-width: 360px; height: 100%"
                src="<?php echo e(asset('assets/default/image/footer-3d.png')); ?>" alt="footer-3d" />
        </div>
    </div>
</section>
<?php /**PATH /Users/lequanganh/workspace/php-space/snapstudy-app/resources/views/components/layouts/footer-banner.blade.php ENDPATH**/ ?>