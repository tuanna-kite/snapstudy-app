...
<div class="xs-panel-nav d-flex d-lg-none justify-content-between py-15 px-15">
    ...
    <button class="sidebar-toggler d-block btn-transparent justify-content-center align-items-center p-5  sidebarNavToggle" type="button">
        
        <i style="" data-feather="menu" width="24" height="24"></i>
    </button>
</div>
...
<div class="panel-sidebar pt-50 pb-25 px-25" id="panelSidebar">
    ...
    <div class="user-info user-info-mj d-flex align-items-center flex-row flex-lg-column justify-content-lg-center">
        <a href="/panel" class="user-avatar bg-gray200">
            <img src="<?php echo e($authUser->getAvatar(100)); ?>" class="img-cover " alt="<?php echo e($authUser->full_name); ?>">
        </a>

        <div class="d-flex flex-column align-items-center justify-content-center user-mjjj">
            <a href="/panel" class="user-name mt-15">
                <h3 class="font-16 font-weight-bold text-left"><?php echo e($authUser->full_name); ?></h3>
            </a>
   ...
   <!-- <div class="d-flex sidebar-user-stats pb-10 ml-20 pb-lg-20 mt-15 mt-lg-30">
    ...
    <ul id="panel-sidebar-scroll" class="sidebar-menu pt-10 <?php if(!empty($authUser->userGroup)): ?> has-user-group <?php endif; ?> <?php if(empty($getPanelSidebarSettings) or empty($getPanelSidebarSettings['background'])): ?> without-bottom-image <?php endif; ?>" <?php if((!empty($isRtl) and $isRtl)): ?> data-simplebar-direction="rtl" <?php endif; ?>>
        ...
        <li class="sidenav-item <?php echo e((request()->is('panel/financial/account')) ? 'sidenav-item-active' : ''); ?>">
            <a href="/panel/financial/account" class="d-flex align-items-center">
                <span class="sidenav-item-icon mr-10">
                ...
                <span class="font-14 text-dark-blue font-weight-500"><?php echo e(trans('financial.charge_account')); ?></span>
            </a>
        </li>
        ...
        <li class="sidenav-item <?php echo e((request()->is('panel/financial') or request()->is('panel/financial/*')) && !request()->is('panel/financial/account') ? 'sidenav-item-active' : ''); ?>">
            ...
            <div class="collapse <?php echo e((request()->is('panel/financial') or request()->is('panel/financial/*')) && !request()->is('panel/financial/account') ? 'show' : ''); ?>" id="financialCollapse">
                <ul class="sidenav-item-collapse">
...
<?php /**PATH /Users/tuanna.kite/workspace/laravel-app/snapstudy-app/resources/views/web/default/panel/includes/sidebar.blade.php ENDPATH**/ ?>