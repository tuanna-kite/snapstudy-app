<div class="dropdown">
    <button style="border:none" type="button" class="btn btn-transparent" <?php echo e((empty($unReadNotifications) or count($unReadNotifications) < 1) ? 'disabled' : ''); ?> id="navbarNotification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<?php /**PATH /Users/lequanganh/workspace/php-space/snapstudy-app/resources/views/web/default/includes/notification-dropdown.blade.php ENDPATH**/ ?>