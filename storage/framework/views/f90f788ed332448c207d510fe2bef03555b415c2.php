<?php $__env->startSection('content'); ?>
    ...
    <div class="p-4 m-3">
        ...
        <form method="POST" action="<?php echo e(getAdminPanelUrl()); ?>/login" class="needs-validation">
            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
            <div class="form-group">
                <div class="d-block">
                    <label for="email"><?php echo e(trans('auth.email')); ?></label>
                </div>
                <input id="email" type="text" value="<?php echo e(old('email')); ?>" class="form-control  <?php $__errorArgs = ['email'];
